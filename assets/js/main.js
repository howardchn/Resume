var appData = {
    title: 'Howard Chen',
    description:
        'Good at .NET, Node.js, Python, Go, React, Dart programming language. Full-Stack Capability to build cross-platform application including desktop, web and mobile. Have 7 years of technical product manager (including 4 years director), 8+ years of team leader and 3 years technical director experience.',
    currentPosition: 'Technical Product Director',
    basicInfo: 'Male  ︳Bachelor Degree ︳ 20 years working experience  ︳Live in Chengdu',
    experiences: [
        {
            type: 'work',
            ...
            details: [
                {
                    ...
                    date: '2023/10 - Now',
                    work: "Empathia is a startup company that focuses on AI scribing for healthcare assistant. Empathia and the previous company were created by the same owner and were formed by several key members from the previous company who moved over. Designed and developed the prototype of the company's current product for fundraising. Later, responsible for the design, development, coordination, testing, and release of multiple major products in the product family, as well as subsequent iterations. Additionally, for several product lines under my responsibility, I comprehensively considered the interaction with other modules and the future development direction.",
                },
                {
                    name: 'MobLab',
                    url: 'https://moblab.com',
                    summary: 'Technical Project Director',
                    date: '2020/04 - 2023/10',
            ...
            details: [
                {
                    ...
                    summary:
                        "Dual Bachelor's Degree (Painting and Design as the First Major + Software Engineering as the Second Major",
                    date: '2000 - 2004',
        ...
        },
        {
            ...
            details: [
                {
                    name: 'Empathia AI Chrome Extension',
                    url: 'https://empathia.ai',
                    summary:
                        "Empathia AI offers a powerful Chrome extension designed to seamlessly integrate with clinicians' workflows, allowing them to access a robust AI-powered medical assistant directly within their EMR systems. With this extension, clinicians can efficiently record conversations alongside their EMR, supporting multilingual dictation and eliminating after-hours administrative tasks. Empathia AI enhances patient care by automating note generation and offering customizable templates, all within a user-friendly interface that's robust enough to function even offline, allowing clinicians to prioritize patient care over paperwork.",
                    date: '2023/10 - Now',
                    work: 'Responsible for all workflow design and development. In this project, I used many new features provide by Extension APIs such as Service Worker, messenger, side-panel, content script and offscreen etc. and some cool features from web, like WebRTC, indexdb to build good experience on audio recording, offline mode, in page web scan including PDF and images, silence detection and notification etc. I also sort out the requirements from customer success team and make it real. The project is still in iteration, and currently it serves 1500+ user per day.',
                },
                {
                    name: 'Empathia Audio Server',
                    summary:
                        'Empathia Audio Server is a powerful audio processing server designed to handle all the audio related needs in the Empathia AI Family. It provides a robust backend for audio recording, transcription, and analysis, ensuring that clinicians can efficiently manage their audio data. The server is built on Golang and utilizes WebRTC for real-time audio streaming, making it a critical component of the Empathia AI ecosystem.',
                    date: '2024/06 - Now',
                    work: "I'm the only developer for this project. It mainly uses Golang and OpenAI Speech to text service to archive the audio to transcript and store the audio files safely. Other than that, the audios has various kinds of problem to impact the transcription, like volume low, noise, silence gap, multilingual, and some minor languages, and data lost on client etc. Thus resolving all those issues is part of challenges in this service. The project is still in iteration.",
                },
                {
                    name: 'Empathia Knowledge Base System',
                    summary:
                        'Empathia Knowledge Base System is a powerful knowledge management system designed to support the needs of the Empathia AI Family.  It allows users to upload massive amount of documents including PDF, txt, images, word files, and convert them into text content and store original text and vertices in the system. Then it could be used to search and compose new documents based on uploaded materials. It is in internal testing stage and will be released in the near future. But now, the internal testers are real doctors and very few lawyers and the feedback seems positive so far.',
                    date: '2024/10 - Now',
                    work: "I'm the designer, developer and product manager for this project. The system is built on React, Node.js and utilizes MongoDB and Chroma for vector storage. The major challenge is to build almost real-time search and compose system over massive uploaded files. Recently, the embedding model is upgraded by OpenAI which is not considered before. I'm still working on it to make it compatible with the new model.",
                },
                {
                    name: 'MobLab Kids',
                    summary:
                        'MobLab Kids is an app that uses behavioral games to evaluate and track various skill metrics for children aged 3-8, while also offering expert recommendations. This app has also developed a range of related SaaS services and apps, such as a daycare journal, a daily training knowledge system, and a kindergarten management SaaS system.',
                    date: '2020/06 - 2022/12',
                    work: 'Responsible for the design, architecture, R&D, submission, core feature development, and subsequent data analysis and iterative output of the entire product line. The product line includes two mobile apps (to C/B) developed with Flutter, a web app developed by React, and a backend service (SaaS based for multi tenant) developed by Node.js. The entire product line is built on a microservice architecture. The backend service is deployed on AWS and uses MongoDB as the major database. Also it uses OpenAI services to support many features, like teacher/parents chat, build training plan, generate knowledge base for kids growth, etc.',
                },
                {
                    name: 'Learning Behavior Analysis System',
                    summary:
                        "This system, initially developed for GSX, analyzes student behavior in online classes and has since been expanded to a multi-tenant model, providing SaaS services to Zuoyebang and the Open University. It consists of a behavior data ingestion system, analysis services, and a front-end display platform. Zuoyebang extracts behavioral data such as class attendance, screen presence, eye movements, and post-class activities daily from its Hadoop database and uploads it to Alibaba Cloud OSS storage. We regularly fetch, incrementally update, and clean this data before storing it in a MySQL database for the data science team. The team trains these data weekly to generate models and produces daily reports on each student's performance. GSX teachers use the system to track student progress, develop learning plans, and facilitate communication with parents by providing suggestions and discussion topics.",
                    date: '2020/04 - 2020/08',
                    work: 'Responsible for the UX design, architecture, R&D, submission, and communicate with GSX and Zuoyebang for the entire product line. Also responsible for data ingestion and cooperate with data science team for the interface design and development and part of UI development tasks.',
                },
                {
                    name: 'Anomaly based alert suppression',
                    summary: 'Determine non-anomaly alerts and suppress them intelligently',
                    date: '2019/05 - 2020/04',
                ...
                },
                {
                    ...
                    summary:
                        'This project is to detect anomalies based on a period of metrics. After finding out the anomalies by machine learning algorithms, we could render the anomalies on a graph widget and some corresponding functions around it.',
                ...
                },
                {
                    ...
                    summary:
                        'This is kubernetes application written by go. It syncs frequently used k8s resources into LogicMonitor platform and keep them monitored.',
                ...
                },
                {
                    ...
                    summary:
                        'StatsD is an open source project that allows user to push their metrics as a unified data format into a specified destination which in our case, LogicMonitor platform is its destination.',
                ...
                },
                {
                    ...
                    summary:
                        'Communicate with US office for new requirements and lead the team for the entire development progress.',
