            ...
            details: [
                {
                    ...
                    summary: '技术产品总监',
                    date: '2023/10 - Now',
                    work: 'Empathia 是一家专注于为医疗助手提供人工智能记录服务的初创公司。Empathia 和前一家公司由同一位创始人创建，并由前公司的一些核心成员转移过来。设计并开发了现公司的产品原型用于融资。后期负责产品家族中多个主要产品的设计，开发，协调以及测试发布，以及后续的迭代。并在自己负责的几个产品线上，通盘考虑其他模块的交互以及后续的发展方向。',
                },
                {
                    name: 'MobLab',
