var appDataCn = {
    ...
    experiences: [
        ...
        },
        {
            type: 'work',
            title: '自我评价和其他',
            description: '具有良好的沟通能力。了解多种编程语言和对应的项目开发经验。能够快速构建产品原型，并琢磨细节和把控风险。工作期间，能在短时间内找到应用程序内部问题的原因并解决。在Web方面，我具有全栈工程师的能力。我有8年左右的团队管理经验，3年多的技术总监，以及2年高级技术产品经理经验。能主动在持续学习新技术的过程中，找到适合公司产品方向并应用。良好的开发进度把控，按时按量进行项目交互。熟悉传统的软件工程及敏捷流程，能根据需求动态切换不同的开发模式，在保证进度的同时兼顾程序的稳定性。我具有良好的英语听说能力和读写能力。闲暇时间喜欢共享开源项目和帮助回答社区问题。目前<a href="https://stackoverflow.com/users/703264/howard" target="_blank">Stackoverflow</a>上的贡献值是2K+，不是很多，处于前17%左右，并持续增加中。如果需要更多了解我，请用一下方式联系：',
            details: [
                {
