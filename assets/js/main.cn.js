var appDataCn = {
    ...
    experiences: [
            ...
            details: [
                {
                    ...
                    work: '负责带领研发组进行Map Suite 10.0维护和新特性添加，具体负责对用户和内部提交的Bug进行修复，同时进行新技术研究，创建新特性雏形并考虑集成到产品线。'
                }, {
        ...
        },
        {
            type: 'work',
            title: '期望工作',
            description: '职务为技术总监，或者项目经理；全职；接受在成都或者远程工作。期望月薪为20K - 30K.'
        },
        {
            type: 'work',
            title: '技能',
            details: [
                {
                    ...
                    date: '2004 - 2017',
                    work: '接触时间很早，在工作前期使用平凡，后期基本都应用于个人项目。了解很多第三方流行的库，不过需要使用文档开发。'
                }, {
                    name: 'Html + CSS',
                    summary: 'Html and CSS, used bootstrap a lot',
                    date: '2004 - 2017 Occasionally',
                    work: '熟悉HTML和CSS，前后开发过5个左右的小中型网站；使用Bootstrap比较多。根据工作需求，愿意接触更多的框架。'
                }, {
                    name: 'NodeJS',
                    summary: '熟悉',
                    date: '2016 - 2017',
        ...
        },
        {
            type: 'work',
            title: '自我评价和其他',
            description: '我的工作期间，几乎所有的时间都是使用.NET开发。能在短时间内找到应用程序内部问题的原因并解决。我代码风格统一，优雅并开发迅速。在Web方面，我具有全栈工程师的能力。我有8年左右的团队管理经验和3年多的技术总监经验，能在学习新技术的过程中，找到适合公司产品并应用，同时兼顾研发人员的开发进度，按时按量提交给客户。属性传统的软件工程及敏捷流程，能根据需求动态切换不同的开发模式，在保证进度的同时兼顾程序的稳定性。我具有良好的英语听说能力和读写能力。同时我<a href="https://stackoverflow.com/users/703264/howard" target="_blank">Stackoverflow</a>上的贡献值是2K+，不是很多，处于前18%左右，并持续增加中。如果需要更多了解我，请用一下方式联系：',
            details: [
                {
                    name: '电话: +86-13540742190'
                }, {
                    name: 'QQ: 17449203',
                }, {
                    name: '微信: Godspeedch'
