var appDataCn = {
    ...
    experiences: [
        ...
        },
        {
            type: 'work',
            title: '自我评价和其他',
            description: '具有良好的沟通能力。了解多种编程语言和对应的项目开发经验。能够快速构建产品原型，并琢磨细节和把控风险。工作期间，能在短时间内找到应用程序内部问题的原因并解决。在Web方面，我具有全栈工程师的能力。我有8年左右的团队管理经验，3年多的技术总监，以及6年高级技术产品经理经验。能主动在持续学习新技术的过程中，找到适合公司产品方向并应用。良好的开发进度把控，按时按量进行项目交付。熟悉传统的软件工程及敏捷流程，能根据需求动态切换不同的开发模式，在保证进度的同时兼顾程序的稳定性。我具有良好的英语听说能力和读写能力。闲暇时间喜欢共享开源项目和帮助回答社区问题。目前<a href="https://stackoverflow.com/users/703264/howard" target="_blank">Stackoverflow</a>上的贡献值是2K+，不是很多，处于前12%左右，并持续增加中。<ol type="1" id="3a66ff14-9e68-4650-a1cf-6de519a362b9" class="numbered-list" start="1"><li>目前&lt;a href=&quot;<a href="https://stackoverflow.com/users/703264/howard">https://stackoverflow.com/users/703264/howard</a>&quot; target=&quot;_blank&quot;&gt;Stackoverflow&lt;/a&gt;上的贡献值是3.5K+，不是很多，处于世界前11%左右，并持续增加中。</li></ol><ol type="1" id="25aa815d-bff4-4a82-bcad-35e65ce2837b" class="numbered-list" start="2"><li>开源一个基于Node.js开发的地图服务搭建SDK - &lt;a href=”<a href="https://ginkgoch.com/">https://ginkgoch.com/</a>”&gt;Ginkgoch&lt;/a&gt;。支持空间运算，多源数据读写，地图渲染等功能。本开源项目具有完整的文档和示例。</li></ol><ol type="1" id="aeae09dc-5049-49fc-9c64-7ff59c874751" class="numbered-list" start="3"><li>开源一个基于Go编写了类Lodash的工具库 - &lt;a href=”<a href="https://github.com/ginkgoch/godash">https://github.com/ginkgoch/godash</a>”&gt;godash&lt;/a&gt;。近期刚更新了v2，支持generic。</li></ol><ol type="1" id="8f47be0a-f97f-48b3-bed3-f15fc25ff988" class="numbered-list" start="4"><li>这个项目（<a href="https://github.com/howardchn/location-to-phone-number">https://github.com/howardchn/location-to-phone-number</a>）很奇怪，一个练手项目居然能冲到170的stars。说明往往用户关心的并不是你的代码质量有多高，而是有多少用户愿意用。</li></ol>如果需要更多了解我，请用以下方式联系：',
            details: [
                {
